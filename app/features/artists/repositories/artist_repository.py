...
from app.features.artists.schemas import ArtistsSyncDto
from app.features.artists.models import Artist, ArtistImage, ArtistName, ArtistUnit
    ...
    async def sync_from_blip_and_mvp(self) -> dict:
        ...
        for item in blip_data:
            ...
            if unit is None:
                ...
                # 업데이트
                unit.name = unit_name or unit.name  # type: ignore[assignment]
                unit.type = type  # type: ignore[assignment]
                unit.is_active = is_active  # type: ignore[assignment]
                unit.is_filter = is_filter_flag  # type: ignore[assignment]
            ...
            if rep_artist is None:
                ...
                # 갱신
                rep_artist.name = unit_name or rep_artist.name  # type: ignore[assignment]
