...
from app.features.artists.models.artist import Artist
from app.features.artists.models.artist_name import ArtistName
...
class ArtistScheduleCRUD:
    ...
    async def get_schedules(
        ...
        return {
            ...
            "page": page,
            "size": size,
            "total_pages": (total_count_value + size - 1) // size,
        }
