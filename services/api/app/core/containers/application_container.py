...
# ===================
# Level 1: Core만 의존하는 Feature Containers
# ===================
...
class ApplicationContainer(containers.DeclarativeContainer):
    ...
    notification_feature: NotificationFeatureContainer = providers.Container(
        ...
        core=core,
        tendency=tendency_feature.tendency,
    )
    pod_feature: PodFeatureContainer = providers.Container(
        PodFeatureContainer,
        core=core,
        follow=follow_feature.follow,
    )
    ...
    user_feature: UserFeatureContainer = providers.Container(
        ...
        core=core,
        follow=follow_feature.follow,
        notification=notification_feature.notification,
        tendency=tendency_feature.tendency,
        pod=pod_feature.pod,
